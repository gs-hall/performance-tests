...
# Добавили описание структуры ответа получения писка счетов
...
class AccountsGatewayHTTPClient(HTTPClient):
    ...
    # Добавили новый метод
    def open_credit_card_account(self, userId: str) -> OpenCreditCardAccountResponseDict:
        request = OpenCreditCardAccountRequestDict(userId=userId)
